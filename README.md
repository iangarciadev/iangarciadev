...
<h2>Conhecimentos:</h2>
<p>Infraestrutura: Windows Server, Active Directory, Linux, Virtualização, Microsoft 365  <br> 

Programação: Python, SQL (SQL Server), JavaScript, HTML/CSS, Git/GitHub, APIs  <br> 
